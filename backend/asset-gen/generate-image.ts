...
export async function generateHouseObjectCustom(): Promise<OpenAI.Images.Image> {
  ...
  const generateImagePrompt = `I NEED to test how the tool works with extremely simple prompts. DO NOT add any detail, just use it AS-IS: A cute aesthetic standard isometric aerial view of a single large square villager's house. ${villageHouseDescription} The house is 30 metres by 30 metres in dimension, sitting on a thin flat perfectly square standard isometric platform of size 40 metres by 40 metres, perfectly centered in the image, maintaining a straightforward composition. The house must be the primary subject of the image, any other secondary elements should be small and entirely contained within the bounds of the platform, allowing for an unobstructed view of the house. Trees and other elements are very small compared to the large house. The entire square platform must be fully visible and fully contained within the frame of the image. The house is quaint and cozy with a storybook charm. The surrounding yard is lightly adorned with tiny complementary elements. The ground is flat greenery with a grassy texture in the color of spring green and the edges of the platform are smooth and straight. Warm, gentle, pleasant light source from the west. Style is 3D boxy art RPG video game with a soft texture. Completely plain white background, floating in white space.`;
